const CardData7 = [
  ...
  },
  {
    ...
    description:
      'Jaguares fue una banda mexicana de rock fue formada después de la separación de Caifanes por diferencias entre Saúl Hernández y Alejandro Marcovich. En lugar de empezar una carrera como solista, Hernández decidió formar otro conjunto musical. Por motivos legales fue imposible reutilizar el nombre Caifanes en el nuevo proyecto, así que se eligió Jaguares en su lugar. Sin embargo, los derechos de autor de varias piezas de Caifanes se mantuvieron en Jaguares por lo que el repertorio de esta tercera banda comúnmente incluye canciones de la agrupación previa.',
    videourl:
      'https://youtube.com/playlist?list=PLWdSX8EMRl9sWu75sFpSR_-khDXZ3ka2z',
    price: '$50',
