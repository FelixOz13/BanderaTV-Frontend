...
const About = () => {
  return (
    <div style={styles.container}>
      ...
      <h1 style={{ fontSize: "2rem", fontFamily: "Rubik", color: "green", margin: '25px' }}>Acerca de Bandera Musical</h1>
      <p style={{ fontSize: "1rem", fontFamily: "Rubik", color: "goldenrod", margin: '25px' }}>
      ...
      <h1 style={{ fontSize: "2rem", fontFamily: "Rubik", color: "green", margin: '25px' }}>Nuestra Misión</h1>
      <p style={{ fontSize: "1rem", fontFamily: "Rubik", color: "goldenrod", margin: '25px' }}>
      ...
      <h1 style={{ fontSize: "2rem", fontFamily: "Rubik", color: "green", margin: '25px' }}>Nuestra Plataforma Digital</h1>
      <p style={{ fontSize: "1rem", fontFamily: "Rubik", color: "goldenrod", margin: '25px' }}>
        Además de nuestra presencia física en el Tianguis Cultural de Guadalajara y el Tianguis de la Av. Chapultepec,
        Bandera Musical cuenta con una vibrante plataforma digital en <a href="https://banderamusical.com/" target="_blank" rel="noopener noreferrer">banderamusical.com</a>
        </p><br/><p style={{ fontSize: "1rem", fontFamily: "Rubik", color: "goldenrod", margin: '25px' }}> Aquí, los fans pueden disfrutar de contenido exclusivo, videos musicales y seguir de cerca las últimas novedades de sus artistas preferidos.
      ...
      <h1 style={{ fontSize: "2rem", fontFamily: "Rubik", color: "green", margin: '25px' }}>Nuestro Compromiso</h1>
      <p style={{ fontSize: "1rem", fontFamily: "Rubik", color: "goldenrod", margin: '25px' }}>
      ...
      <h1 style={{ fontSize: "2rem", fontFamily: "Rubik", color: "green", margin: '25px' }}>Inspiración y Concepto</h1>
      <p style={{ fontSize: "1rem", fontFamily: "Rubik", color: "goldenrod", margin: '25px' }}>
