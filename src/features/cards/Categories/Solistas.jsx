...
const Solistas = () => {
  ...
  useEffect(() => {
    console.log("Dispatching 'Roc' category fetch");
    dispatch(getCardsByCategory('Rock-Pop','Pop Americano', 'Mariachi','Baladas', 'Soft Rock')); // Ensure category name matches backend data
  }, [dispatch]);
